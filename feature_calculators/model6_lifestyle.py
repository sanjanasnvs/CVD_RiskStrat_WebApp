...
def calculate_features(patient_id, submission_id):
    ...
    raw_features = calculate_model_features(
        ...
        template_path='model_files/feature_templates/model6_Lifestyle_env_features.xlsx'
    )
    ...
    with open('model_files/imputers/lifestyle_and_environmentnoDrop_rf (1).pkl', 'rb') as f:
    ...
    try:
        with open('model_files/scalers/lifestyle_and_environmentnoDropscaler.pkl', 'rb') as f:
    ...
    out_path = f"model_outputs/patient_{patient_id}_model6_input_scaled.csv"
