...
def calculate_features(patient_id, submission_id):
    ...
    raw_features = calculate_model_features(
        ...
        template_path='model_files/feature_templates/model4_earlylifefactors_features.xlsx'
    )
    ...
    with open('model_files/imputers/earlyLifeFactorsnoDrop_rf.pkl', 'rb') as f:
    ...
    try:
        with open('model_files/scalers/earlyLifeFactorsnoDropscaler.pkl', 'rb') as f:
    ...
    out_path = f"model_outputs/patient_{patient_id}_model4_input_scaled.csv"
